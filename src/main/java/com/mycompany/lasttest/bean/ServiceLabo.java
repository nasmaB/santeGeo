 ...
 */
@Entity
public class ServiceLabo implements Serializable {

    @ManyToMany(mappedBy = "serviceLabos")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ServiceLabo)) {
            return false;
        }
        ServiceLabo other = (ServiceLabo) object;
    ...
    public String toString() {
        return "com.example.demo.bean.ServiceLabo[ id=" + id + " ]";
    }
